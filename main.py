...
def parse_opt(known=False):
    ...
    parser.add_argument('-t', '--title_name', default='MS COCO Object Detection', help="figure name")
    parser.add_argument('-x', '--xlabel_name', default='PyTorch FP16 RTX3080(ms/img)', help="figure name")
    parser.add_argument('-y', '--ylabel_name', default='COCO Mask AP val', help="figure name")
    parser.add_argument('-f', '--font_size', default=10, help="figure name")
